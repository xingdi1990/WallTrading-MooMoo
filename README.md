...
2. Install MooMoo/Futu OpenD: https://www.moomoo.com/download/OpenAPI

2. Install requirements: run in CMD under root directory:
```
pip install -r requirements.txt
```
4. Go to the `env/_secret.py` and fill in your trading password and Discord info.
...
⏫Get more from LookAtWallStreet on Patreon⏫
<br>
